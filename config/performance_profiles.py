    ...
    if name in {"realtime", "desktop", "tiny", "ultrafast"}:
        return replace(
            ...
            memory=replace(
                ...
                residual_recall_deepen_grasp_threshold=1.01,
                residual_recall_min_primary_rows=1,
                slow_residual_recall_enabled=True,
                long_term_recall_kinds=("state", "focus", "short_term_slot"),
    ...
    if name in {"high", "high_accuracy", "large"} and target >= 100:
        return replace(
            ...
            memory=replace(
                ...
                residual_recall_deepen_grasp_threshold=0.72,
                residual_recall_min_primary_rows=2,
    ...
    return replace(
        ...
        state_pool=replace(
            ...
            posting_display_token_limit=128,
                ...
                residual_recall_deepen_grasp_threshold=0.68,
                residual_recall_min_primary_rows=2,
