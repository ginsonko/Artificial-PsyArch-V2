...
发布版已经完成短主文、长技术报告、新闻稿、三个公开仓库、许可证、manifest、SHA-256 锚点和第三方复现材料整理。下面这些项目不再是发布门槛, 而是后续冲击更高审稿评价的增强项:
...
新闻稿: `APV2_新闻稿_让机器一直是它自己_20260614.docx` / `.pdf`
...
| 新闻稿 | 媒体、普通技术读者、第一次接触 AP 的读者 | 用非论文语言解释 APV2 为什么重要、和大模型是什么关系 |
